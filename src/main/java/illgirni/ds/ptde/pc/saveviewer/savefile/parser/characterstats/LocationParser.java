...
/**
 * Uses the {@link LocationDefinition} to parse the current location from the byte block
...
public class LocationParser extends AbstractSaveElementParser {
    ...
    public Location parse(final ByteBlock locationBlock) {
        return Location.getLocationFor(blockSectionParser.parse(locationDefinition.getMainAreaDefinition(), locationBlock), 
