...
/**
 * Sets up the application to start the user interface. Wraps an {@link UIApplication} as singleton
 * and starts it after initializing everything needed for a user interface.
 * <p/>
 * Provides static access to a number of properties of the started application and user interface
 * "resources".
 * 
 * @author illgirni
 *
...
public class UIStarter extends Application {
  ...
  /**
   * If the UI resources have not yet been prepared starts the given application after preparing the
   * resources.
   * 
