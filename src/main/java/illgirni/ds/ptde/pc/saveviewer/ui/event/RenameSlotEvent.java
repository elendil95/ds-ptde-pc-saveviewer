...
/**
 * Event to indicate that an exported slot has to be renamed. Payload is the slot to 
 * be renamed.
 * 
 * @author illgirni
 *
...
public class RenameSlotEvent extends AbstractEvent<ExportedSlot> {
     ...
     */
    public static final EventType<RenameSlotEvent> RENAME_SLOT = new EventType<>(SAVE_VIEWER_EVENT, "RENAME_SLOT");
