 ...
 * magics section.
 * <p/>
 * For an attunement slot it is only important to know which magic is attuned in that slot. We 
 * don't need to known about the available quantity of that magic in our inventory, because there 
 * is always only one in the slot.
 * 
 * @author illgirni
 *
 */
