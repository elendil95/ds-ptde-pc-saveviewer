...
public final class WorkspaceConstants {
  ...
  /**
   * Default name for the directory containing the workspace (content file, exported slots, and
   * settings).
   */
  ...
  public static final String DEFAULT_SAVE_FILE_PATH =
      FileSystemView.getFileSystemView().getDefaultDirectory().getPath() + File.separator + "NBGI"
          + File.separator + "DarkSouls" + File.separator + "DRAKS0005.sl2";
