...
/**
 * The dialog in which to choose a new group containing an already exported slot. Does not allow to
 * choose the root as container (because it is not a group).
 * 
 * @author illgirni
 *
 */
public class MoveExportedSlotDialog extends AbstractMoveExportedElementDialog {
   ...
   */
  public MoveExportedSlotDialog(final String movedSlotName,
