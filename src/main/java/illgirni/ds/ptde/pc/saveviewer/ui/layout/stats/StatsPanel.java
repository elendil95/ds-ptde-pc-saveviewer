...
/**
 * A details panel which shows a character's stats. The shown elements are grouped in thematic 
 * lists (e.g. levelable stats, basic character properties), which are aligned as a grid with 
