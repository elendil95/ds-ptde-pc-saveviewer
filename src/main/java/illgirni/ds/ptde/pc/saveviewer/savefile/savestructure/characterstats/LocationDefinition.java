...
/**
 * The characters current location is defined by an area/world id. The id consists of a 
 * "main area" id and a "sub-area" id stored within the location section of the save slot.
 * 
 * @author illgirni
 *
 */
