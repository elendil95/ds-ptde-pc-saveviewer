...
/**
 * Indicates that the details of a slot in the save file have to be displayed. Payload
 * is the slot.
 * 
 * @author illgirni
 *
...
public class ShowSaveFileSlotEvent extends AbstractEvent<SaveSlot> {
     ...
     */
    public static final EventType<ShowSaveFileSlotEvent> SHOW_SAVE_FILE_SLOT = new EventType<>(SAVE_VIEWER_EVENT, "SHOW_SAVE_FILE_SLOT");
