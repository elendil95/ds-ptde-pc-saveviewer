...
public class InventoryItemDefinition {
  ...
  /**
   * The main item type. This is a one byte indicator value. Well, actually it's four, but only one
   * byte is used.
   */
  ...
  /**
   * The maximum durability of the item. This will of course only be a sensible value, if the item
   * is equipable gear or a weapon.
   */
  ...
  /**
   * The current durability of the item. This will of course only be a sensible value, if the item
   * is equipable gear or a weapon.
   */
