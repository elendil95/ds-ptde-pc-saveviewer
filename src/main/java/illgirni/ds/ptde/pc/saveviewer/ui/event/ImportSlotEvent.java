...
/**
 * Event to indicate that an exported slot should be imported into the save file. Payload is the
 * slot to import.
 * 
 * @author illgirni
 *
...
public class ImportSlotEvent extends AbstractEvent<SaveSlot> {
   ...
   */
  public static final EventType<ImportSlotEvent> IMPORT_SLOT =
      new EventType<>(SAVE_VIEWER_EVENT, "IMPORT_SLOT");
