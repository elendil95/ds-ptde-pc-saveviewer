...
public class TailcutsStateParser extends AbstractSaveElementParser {
  ...
  public TailcutsState parse(final List<TailcutBitBlock> tailcutBitBlocks) {
    ...
    for (final TailcutStateDefinition tailcutDefinition : tailcutsStateDefinition
      ...
      if (matchingGroupBitBlock != null) {
        tailcutsState
            .addTailcutState(tailcutStateParser.parse(tailcutDefinition, matchingGroupBitBlock));
      } else {
        throw new RuntimeException(
            "Missing tailcut definition: " + tailcutDefinition.getRepresentor());
      }
