...
/**
 * Registry/cache of images. Allows static access to images without knowing the file name and using
 * {@link ImageKey} instead. Loads each image only once (upon first request) and then retrieves them
 * from a cache on subsequent requests.
 * 
 * @author illgirni
 *
 */
