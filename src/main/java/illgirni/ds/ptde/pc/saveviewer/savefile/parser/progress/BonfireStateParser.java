...
public class BonfireStateParser extends AbstractSaveElementParser {
  ...
  public BonfireState parse(final ByteBlock bonfireStateBlock) throws ParserException {
    ...
    final long bonfireId =
        blockSectionParser.parse(bonfireStateDefinition.getBonfireDefinition(), bonfireStateBlock);
    final Bonfire bonfire = getBonfireForId(bonfireId);
    final BonfireStrength bonfireStrength = bonfireStrengthParser.parse(blockSectionParser
        .parse(bonfireStateDefinition.getBonfireStrengthDefinition(), bonfireStateBlock));
