...
/**
 * Indicates that the details of an exported slot have to be displayed. Payload is the exported
 * slot.
 * 
 * @author illgirni
 *
...
public class ShowExportedSlotEvent extends AbstractEvent<ExportedSlot> {
   ...
   */
  public static final EventType<ShowExportedSlotEvent> SHOW_EXPORTED_SLOT =
      new EventType<>(SAVE_VIEWER_EVENT, "SHOW_EXPORTED_SLOT");
