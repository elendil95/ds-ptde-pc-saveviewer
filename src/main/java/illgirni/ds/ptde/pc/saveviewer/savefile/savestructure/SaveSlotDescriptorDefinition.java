 ...
 * <ol>
 * <li><i>Slot Name Offset:</i> Offset of the name of a save slot (not the name of the slot's
 * character!) in the save file.</li>
 ...
 * </ol>
 * Structure definition of the definition of a slot's location, size, and name in the save file.
 */
@Bean
