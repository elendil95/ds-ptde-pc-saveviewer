...
/**
 * A panel to show the details of a save slot. Supports multiple layouts: tabbed, split panel, 
 * and list. Which layout is used depends on user preferences. Also defines controls to import 
 * an exported slot and export a save file slot.
 * 
 * @author illgirni
 *
 */
public class SaveSlotDetailsPanel extends BorderPane {
    ...
    /**
     * Creates the main content with all the detail sub-panels. Which kind of node is created
    ...
    private Node createSplitContent() {
        ...
        final Node progressList = createDetailSectionsListing(bossesPanel, tailcutsPanel, warpPanel, bonfiresPanel);
    ...
    private Node createListedContent() {
        return createDetailSectionsListing(statsPanel, equipmentPanel, bossesPanel, tailcutsPanel, warpPanel, bonfiresPanel);
    }
    ...
    private Node createDetailSectionsListing(Node... detailSections) {
        ...
        listedContent.setStyle("-fx-background-color: #ccc; -fx-border-width: 1 1 1 1; -fx-border-color: #999");
     ...
     * @param standalone If the import ({@code true}) or export ({@code false}) controls have to be shown.
     */
    ...
    /**
     * The title panel. Shows the character gender, name, and import/export controls.
     * Only one of the import and export controls is shown at a time.
     */
    private class TitlePanel extends GridPane {
        ...
        /**
         * Sets which of the import/export controls is shown. Adapts the controls to fire
         * the correct events for the slot.
         * 
