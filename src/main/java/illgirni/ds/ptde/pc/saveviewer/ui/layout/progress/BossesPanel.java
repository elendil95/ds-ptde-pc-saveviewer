 ...
 * The order of the bosses corresponds to the discovery order in a "usual playthrough". 
 * 
 * @author illgirni
 *
 */
public class BossesPanel extends AbstractDetailsPanel {
    ...
    private int createBlock1(final GridPane bossesContainer, final int column, int row) {
        List<Boss> bossBlock = Arrays.asList(Boss.ASYLUM_DEMON,
                                             Boss.TAURUS,
                                             Boss.BELL_GARGOYLES,
                                             Boss.CAPRA_DEMON,
                                             Boss.GAPING_DRAGON,
    ...
    private int createBlock2(GridPane bossesContainer, int column, int row) {
        List<Boss> bossBlock = Arrays.asList(Boss.CEASELESS_DISCHARGE,
                                             Boss.STRAY_DEMON,
    ...
    private int createBlock3(GridPane bossesContainer, int column, int row) {
        List<Boss> bossBlock = Arrays.asList(Boss.PRISCILLA,
                                             Boss.SEATH,
                                             Boss.PINWHEEL,
                                             Boss.NITO,
                                             Boss.DEMON_FIRESAGE,
    ...
    private int createBlock4(GridPane bossesContainer, int column, int row) {
        List<Boss> bossBlock = Arrays.asList(Boss.SIF,
                                             Boss.FOUR_KINGS,
