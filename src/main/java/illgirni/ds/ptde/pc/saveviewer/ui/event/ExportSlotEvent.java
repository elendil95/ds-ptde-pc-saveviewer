...
/**
 * Event to indicate that a slot should be exported from the save file. Payload
 * is the slot to export.
 * 
 * @author illgirni
 *
 */
public class ExportSlotEvent extends AbstractEvent<SaveSlot> {
     ...
     */
    public static final EventType<ExportSlotEvent> EXPORT_SLOT = new EventType<>(SAVE_VIEWER_EVENT, "EXPORT_SLOT");
