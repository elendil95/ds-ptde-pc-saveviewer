 ...
 * <ol>
 *  <li><i>Checksum:</i> An MD5 checksum over the remainder of the slot (slot content length + slot content).</li>
 *  <li><i>Slot content length:</i> The length of the save slot content in bytes. This is always the same value.</li>
...
public class SaveSlotDefinition {
    ...
    /**
     * The section with length of the actual slot content. This are the first four bytes right after the 
     * slots checksum.
     */
    ...
    /**
     * The section with the actual slot content. Simply the block of remaining bytes in the slot after the 
     * slot content length.
     */
