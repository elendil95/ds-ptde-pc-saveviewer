...
/**
 * Event to indicate that an exported slot has to be moved to a new group. Payload is the slot to
 * move.
 * 
 * @author illgirni
 *
...
public class MoveSlotEvent extends AbstractEvent<ExportedSlot> {
   ...
   */
  public static final EventType<MoveSlotEvent> MOVE_SLOT =
      new EventType<>(SAVE_VIEWER_EVENT, "MOVE_SLOT");
