...
/**
 * Sub-section definition of a single equipped accessory or consumable within the slot contents accessories 
 * and consumables sections. It specifies:
 * <ul>
 *  <li>the type of the item</li>
 *  <li>the offset of the item id within the equipped item ids section</li> 
 *  <li>the offset of the inventory pointer within the equipped item inventory pointers section.
 *      We need that pointer to determine the quantity of consumables and ammunition.</li>
...
public class EquippedItemDefinition {
     ...
     * @param inventoryIndexOffset The offset of the inventory pointer in the inventory pointers section.
     * @param emptySlotIndicator The "id" indicating that the equipped itme slot is empty.
     */
    public EquippedItemDefinition(final ItemIdSpace idSpace, final int itemIdOffset, final int inventoryIndexOffset, final long emptySlotIndicator) {
