...
/**
 * Event to indicate that a group has to be renamed. Payload is the group to be renamed.
 * 
 * @author illgirni
 *
 */
public class RenameGroupEvent extends AbstractEvent<ExportedSlotGroup> {
   ...
   */
  public static final EventType<RenameGroupEvent> RENAME_GROUP =
      new EventType<>(SAVE_VIEWER_EVENT, "RENAME_GROUP");
