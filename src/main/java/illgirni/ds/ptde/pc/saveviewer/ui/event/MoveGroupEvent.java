...
/**
 * Event to indicate that a group has to be moved to a new parent group. Payload
 * is the group to move.
 * 
 * @author illgirni
 *
 */
public class MoveGroupEvent extends AbstractEvent<ExportedSlotGroup> {
     ...
     */
    public static final EventType<MoveGroupEvent> MOVE_GROUP = new EventType<>(SAVE_VIEWER_EVENT, "MOVE_GROUP");
