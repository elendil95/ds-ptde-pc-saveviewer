...
public class BossesProgressParser extends AbstractSaveElementParser {
    ...
    public BossesProgress parse(final List<BossGroupBitBlock> bossGroupBitBlocks) {
        ...
        for (final BossProgressDefinition bossProgressDefinition : bossesProgressDefinition.getBossProgressDefinitions()) {
            ...
            if (matchingGroupBitBlock != null) {
                bossesProgress.addBoss(bossProgressParser.parse(bossProgressDefinition, matchingGroupBitBlock));
            } else {
                //TODO throw ParserException instead.
                throw new RuntimeException("Missing boss definition: " + bossProgressDefinition.getRepresentor());
            }
