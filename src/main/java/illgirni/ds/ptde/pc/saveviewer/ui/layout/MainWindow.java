...
public class MainWindow extends Scene {
    ...
    /**
     * Sets up the content of the window and applies style sheets to the window 
    ...
    /**
     * Creates the application menu. The menu elements fire events corresponding
     * to the clicked menu entry.
     */
    ...
    /**
     * The actual window content. It is a split pane defining two "columns". The left column 
     * is split into two rows. The "spaces" created in that manner have scroll panes as their 
     * root elements.
     */
    private static class WindowContent extends SplitPane {
        ...
        public WindowContent() {
            ...
            if (LayoutUtils.getPreferenceValue(PreferenceSetting.WINDOW_MAXIMIZED) == 1) {
                Platform.runLater(() -> setDividerPositions(LayoutUtils.getPreferenceValue(PreferenceSetting.WINDOW_DIVIDER) 
                                                            / getScene().getWindow().getWidth()));
                
            } else {
                Platform.runLater(() -> setDividerPositions((1.0 * LayoutUtils.getPreferenceValue(PreferenceSetting.WINDOW_DIVIDER)) 
