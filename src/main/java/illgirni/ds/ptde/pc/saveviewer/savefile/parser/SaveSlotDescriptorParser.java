...
/**
 * Uses the {@link SaveSlotDescriptorDefinition} to transform a block of bytes to a {@link SaveSlotDescriptor}.
 * 
 * @author illgirni
 *
 */
...
public class SaveSlotDescriptorParser extends AbstractSaveElementParser {
    ...
    public SaveSlotDescriptor parse(final ByteBlock slotDescriptorData, int slotIndex) {
        ...
        slotDescriptor.setSlotOffset(blockSectionParser.parse(slotDescriptorDefinition.getSlotOffsetDefinition(), slotDescriptorData));
        slotDescriptor.setSlotLength(blockSectionParser.parse(slotDescriptorDefinition.getSlotLengthDefinition(), slotDescriptorData));
        slotDescriptor.setSlotNameOffset(blockSectionParser.parse(slotDescriptorDefinition.getSlotNameOffsetDefinition(), slotDescriptorData));
