...
public enum PreferenceSetting {
  ...
  /**
   * The position of the divider between slot lists and slot details panels at application start.
   */
   ...
   */
  private PreferenceSetting(final String preferencesKey, final int defaultValue, final int minValue,
      final int maxValue) {
