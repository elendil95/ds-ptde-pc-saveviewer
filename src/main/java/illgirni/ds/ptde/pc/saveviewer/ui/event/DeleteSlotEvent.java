...
/**
 * Event to indicate that an exported slot should be deleted. Payload
 * is the slot to delete.
 * 
 * @author illgirni
 *
 */
public class DeleteSlotEvent extends AbstractEvent<ExportedSlot> {
     ...
     */
    public static final EventType<DeleteSlotEvent> DELETE_SLOT = new EventType<>(SAVE_VIEWER_EVENT, "DELETE_SLOT");
