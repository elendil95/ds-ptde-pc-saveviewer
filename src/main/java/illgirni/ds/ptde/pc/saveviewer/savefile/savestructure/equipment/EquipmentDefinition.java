 ...
 * </ol>
 * 
 * For an empty "equipment slot" there is always a special value/id indicating that the slot is
 * empty. The value is different for different accessory types.
 * 
 * @author illgirni
 *
 */
...
public class EquipmentDefinition {
  ...
  /**
   * The section within the slot content containing the equipped accessory ids and consumables.
   */
  ...
  /**
   * The section within the slot content containing the inventory pointers for the equipped
   * accessories .
   */
  ...
  public List<AttunedMagicDefinition> getAttunedMagicDefinitions() {
    ...
    for (int attunedMagicIndex = 0; attunedMagicIndex < ATTUNED_MAGIC_BLOCKS; attunedMagicIndex++) {
      attunedMagicDefinitions
          .add(new AttunedMagicDefinition(attunedMagicIndex * ATTUNED_MAGIC_BLOCK_LENGTH));
    }
