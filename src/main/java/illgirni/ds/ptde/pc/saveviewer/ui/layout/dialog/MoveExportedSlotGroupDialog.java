...
/**
 * The dialog to choose a new parent for an exported slot group. It is allowed to choose the "nothing"
 * to make the group a root group.
 * 
 * @author illgirni
 *
 */
public class MoveExportedSlotGroupDialog extends AbstractMoveExportedElementDialog {
     ...
     */
    public MoveExportedSlotGroupDialog(final String movedGroupName, final ExportedSlotsWrapper parentGroups) {
