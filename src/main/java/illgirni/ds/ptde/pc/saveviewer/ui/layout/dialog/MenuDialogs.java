...
public final class MenuDialogs {
  ...
  public static void showAboutDialog() {
    Alert aboutDialog =
        BasicDialogs.createSimpleDialog("About", "DARK SOULS - PREPARE TO DIE - PC Save Viewer");
  ...
  public static void showFileInfoDialog(final String saveFilePath, final String workspacePath) {
    Alert fileInfoDialog = BasicDialogs.createSimpleDialog("File Info",
        "This is were you find the files of this application.");
  ...
  public static void showCreditsDialog() {
    ...
    final Text jappi88Text =
        new Text("His save editor really helped to understand the save file structure!");
    ...
    final Text wulf2kText = new Text(
        "The DSCM source code helped to find the boss information and some hidden stats in the saves!");
    ...
    final Text illusoryText =
        new Text("For their item lists and and other findings - like the hidden death counter.");
    ...
    final Text cheatEngineText =
        new Text("All the dudes and dudettes creating the cheat engine tables. "
    ...
    // spread sheet:
    // https://docs.google.com/spreadsheets/d/1KukblWL61We64-gNIyaAShga9h8RTXYmyFs98eQhY4E/edit#gid=1621557847
  ...
  private static TextField createAutosizedField() {
    ...
    autosizedField.textProperty().addListener((ov, prevText, currText) -> {
      ...
      double width = text.getLayoutBounds().getWidth() // This big is the Text in the TextField
          + autosizedField.getPadding().getLeft() + autosizedField.getPadding().getRight() // Add
                                                                                           // the
                                                                                           // padding
                                                                                           // of the
                                                                                           // TextField
      ...
      autosizedField.positionCaret(autosizedField.getCaretPosition()); // If you remove this line,
                                                                       // it flashes a little bit
