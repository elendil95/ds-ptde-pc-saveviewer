...
/**
 * Utility to convert bytes in byte arrays, with the bytes in little endian order,
 * to other types.
 * 
 * @author illgirni
 *
...
public class ByteUtils {
    ...
    public static Integer readInt32(final byte[] byteData, final int offset) {
        return Byte.toUnsignedInt(byteData[offset + 3]) << 24 
                ...
                | Byte.toUnsignedInt(byteData[offset + 1]) << 8 
                | Byte.toUnsignedInt(byteData[offset]);
    }
    ...
    public static Long readUInt32(final byte[] byteData, final int offset) {
        return Byte.toUnsignedLong(byteData[offset + 3]) << 24 
                ...
                | Byte.toUnsignedLong(byteData[offset + 1]) << 8 
                | Byte.toUnsignedLong(byteData[offset]);
    }
    ...
    public static Long readUInt16(final byte[] byteData, final int offset) {
        return Byte.toUnsignedLong(byteData[offset + 1]) << 8 
                | Byte.toUnsignedLong(byteData[offset]);
    }
    ...
    /**
     * Reads a block of bytes from the byte array. The data in the block will be a copy of the
     * read section of the array.
     * 
     * @param byteData The byte array.
     * @param offset The offset in the array.
     * @param length The number of bytes to read into the block. When negative reads everything
    ...
    /**
     * Reads a block of bytes from the byte array. The data in the block will be a copy of the
     * read section of the array. Reads from the offset to the end of the array.
     * 
     * @param byteData The byte array.
     * @param offset The offset in the array.
     * @return The read block.
    ...
    /**
     * Reads the bits of one byte in the byte array into a boolean array. The resulting
     * array will always have a length of eight. A {@code true} value in the array is
     * equivalent to a {@code 1}-bit.
     * 
     * @param byteData The byte array.
     * @param offset The offset of the byte.
    ...
    /**
     * Reads an UTF-16 encoded String from the byte array. Read from the offset until two {qcode 0}-bytes following 
    ...
    public static String readStringUtf16(final byte[] byteData, final int offset, final int stringLength) {
        if (stringLength < 0) {
