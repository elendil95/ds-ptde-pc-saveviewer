...
/**
 * The character stats we are interested in are distributed over three blocks within the save slot content:
 * <ol>
...
public class CharacterStatisticsDefinition {
     ...
     * (so two byte per char). It always ends with a to {@code 0 } bytes. So we read as much String 
     * as we can.
     */
