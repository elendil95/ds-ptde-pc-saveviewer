...
/**
 * Utility to access the user preferences, open new windows, and get the application's 
 * style sheets.
 * 
 * @author illgirni
 *
...
public class LayoutUtils {
    ...
    /**
     * The content of the font size CSS file. The actual font size can be set in this with MessageFormat.
     */
    public static final String FONT_SIZE_FILE_CONTENT_FORMAT = ".root'{'-fx-font-size:{0,number,integer};'}'";
    ...
    /**
     * The user preferences as properties. Changes in the returned properties Object
     * do not reflect on the current settings.
     */
    ...
    /**
     * Loads the user defined preferences. Uses the main preference file ({@link #getPreferencesFile()})
     * and font size file ({@link #getFontSizeFile()}) as sources.
     */
            ...
            if (fontSizeFile != null && fontSizeFile.isFile()) {
                try {
                    ...
                    if (fontSizeMatcher.find()) {
                        preferences.put(PreferenceSetting.FONT_SIZE.getPreferencesKey(), fontSizeMatcher.group(1));
                    } 
