 ...
 * groups, which are aligned as a grid with two columns. Each list entry consists of label-value-pairs.
 * The order of the bonfires corresponds to the discovery order in a "usual playthrough". 
 * 
 * @author illgirni
 *
 */
public class BonfiresPanel extends AbstractDetailsPanel {
    ...
    private int createBlock1(final GridPane bonfiresContainer, final int column, int row) {
        List<Bonfire> bonfireBlock = Arrays.asList(Bonfire.UNDEAD_ASYLUM_COURTYARD, 
                                                   Bonfire.UNDEAD_ASYLUM_CHAMBER, 
                                                   Bonfire.FIRELINK_SHRINE, 
                                                   Bonfire.UNDEAD_BURG, 
                                                   Bonfire.SUNLIGHT_ALTAR, 
                                                   Bonfire.UNDEAD_PARISH, 
                                                   Bonfire.DARKROOT_GARDEN, 
                                                   Bonfire.DARKROOT_BASIN, 
                                                   Bonfire.DEPTHS, 
                                                   Bonfire.BLIGHTTOWN_SHANTY,
                                                   Bonfire.BLIGHTTOWN_SWAMP);
    ...
    private int createBlock2(GridPane bonfiresContainer, int column, int row) {
        List<Bonfire> bonfireBlock = Arrays.asList(Bonfire.GREAT_HOLLOW, 
                                                   Bonfire.ASH_LAKE, 
                                                   Bonfire.STONE_DRAGON, 
                                                   Bonfire.SENS_FORTRESS, 
                                                   Bonfire.ANOR_LONDO, 
                                                   Bonfire.ANOR_LONDO_KEEP, 
                                                   Bonfire.CHAMBER_OF_THE_PRINCESS, 
                                                   Bonfire.DARKMOON_TOMB, 
                                                   Bonfire.PAINTED_WORLD, 
                                                   Bonfire.DUKES_ARCHIVE_ENTRANCE,
                                                   Bonfire.DUKES_ARCHIVE_PRISON);
    ...
    private int createBlock3(GridPane bonfiresContainer, int column, int row) {
        List<Bonfire> bonfireBlock = Arrays.asList(Bonfire.DUKES_ARCHIVE, 
                                                   Bonfire.CRYSTAL_CAVES, 
                                                   Bonfire.CATACOMBS_ENTRANCE, 
                                                   Bonfire.CATACOMBS, 
                                                   Bonfire.TOMB_OF_GIANTS_1, 
                                                   Bonfire.TOMB_OF_GIANTS_2, 
                                                   Bonfire.GRAVELORD_ALTAR, 
                                                   Bonfire.DAUGHTER_OF_CHAOS, 
                                                   Bonfire.DEMON_RUINS_1, 
                                                   Bonfire.DEMON_RUINS_2,
                                                   Bonfire.DEMON_RUINS_3);
    ...
    private int createBlock4(GridPane bonfiresContainer, int column, int row) {
        List<Bonfire> bonfireBlock = Arrays.asList(Bonfire.LOST_IZALITH_ENTRANCE, 
                                                   Bonfire.LOST_IZALITH, 
                                                   Bonfire.BED_OF_CHAOS, 
                                                   Bonfire.ABYSS, 
     ...
     */
    private void createBlock(GridPane bonfiresContainer, int column, int row, List<Bonfire> bonfireBlock) {
