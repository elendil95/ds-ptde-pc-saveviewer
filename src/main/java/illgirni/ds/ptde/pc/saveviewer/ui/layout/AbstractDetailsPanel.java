 ...
 * <p/>
 * The panel itself is a grid. The convenience methods allow to add cells in a specific style
 * to the grid.
 * <p/> 
 * The details shown in this panel are intended to be lists consisting of label-value-pairs.
 * The convenience methods allow to add cells for the labels and pairs shown in the panel.
 * 
 * @author illgirni
 *
 */
public abstract class AbstractDetailsPanel extends GridPane {
    ...
    /**
     * Sets up this panel by building and adding this panel's child elements. Allows sub-classes 
     * to define their content contributions with {@link #fillContentGrid(GridPane)}.
     */
     ...
     * @param position If the label is the first, middle, or last in a list of labels. This 
     *                 determines the border drawn around the label. 
     * @param column The column of the label cell in the container.
     * @param row The row of the label cell in the container.
     */
    protected final void addLabelGridCell(final GridPane container, final String cellText, final VPos position, final int column, final int row) {
     ...
     * @param position If the label is the first, middle, or last in a list of values. This 
     *                 determines the border drawn around the value. 
     * @param column The column of the label cell in the container.
     * @param row The row of the label cell in the container.
     * 
     * @return The node containing the value text.
     */
    protected final Text addValueCell(final GridPane container, final String cellText, final VPos position, final int column, final int row) {
     ...
     *                 determines the border drawn around the value. 
     * 
     * @return A pair of the styled node wrapping the the value text node and the wrapped value text node.
     */
    protected final Pair<TextFlow, Text> createValueCell(final String cellText, final VPos position) {
        ...
        style.append(BORDER_COLOR)
             .append(WHITE_BACKGROUND_COLOR);
