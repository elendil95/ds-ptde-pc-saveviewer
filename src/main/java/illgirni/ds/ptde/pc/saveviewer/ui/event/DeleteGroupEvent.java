...
/**
 * Event to indicate that a group for exported slots should be deleted. Payload is the group to
 * delete.
 * 
 * @author illgirni
 *
...
public class DeleteGroupEvent extends AbstractEvent<ExportedSlotGroup> {
   ...
   */
  public static final EventType<DeleteGroupEvent> DELETE_GROUP =
      new EventType<>(SAVE_VIEWER_EVENT, "DELETE_GROUP");
