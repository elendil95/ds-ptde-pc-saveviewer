...
/**
 * The level of a covenant is determined by the number of "items" that have been offered 
 * for the covenant. The progress of all the "levelable" covenants is stored in one section
 * within the character stats. The progress of a particular covenant takes up one byte in
 * this section.
 * 
 * @author illgirni
 *
...
public class CovenantLevelsDefinition {
    ...
    /**
     * For the given covenant provides the sub-section with the covenant's progress within
     * the character stats covenants progress section.
     * 
