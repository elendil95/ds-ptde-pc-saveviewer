...
/**
 * Parses the tail cut information for a single tail owner from a "tail cut bit block" containing information
 * for possibly multiple tail owners.
 * 
 * @author illgirni
 *
 */
...
public class TailcutStateParser extends AbstractSaveElementParser {
     ...
     */
    public TailcutState parse(TailcutStateDefinition tailcutDefinition, TailcutBitBlock tailcutBitBlock) {
